...
export function CategoryBar({ categories, activeCategory, onCategoryChange, isLoading: externalLoading, isVisible = true }: CategoryBarProps) {
    ...
    return (
        <>
            {/* Category Bar - Super smooth scroll hide/show with hardware acceleration */}
            <div

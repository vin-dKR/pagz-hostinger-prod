        ...
        <div className="flex items-center justify-between gap-2">
            {Array.from({ length }).map((_, i) => (
                <input
                    ...
                    onPaste={handlePaste}
                    disabled={disabled}
                    className={`w-12 h-14 text-center text-2xl font-mono font-semibold bg-gray-50 border rounded-lg outline-none transition-colors focus:ring-2 focus:ring-primary focus:border-primary disabled:opacity-50 ${
